...
def get_fragbond(frag_idx, cnx_attr):
    ...
    edge_index_fragbond_graph = torch.tensor(
        edge_index_fragbond_graph, dtype=torch.int32
    )
...
class CreateDataDTA(CreateData):
    def __init__(
        ...
        super().__init__(
            ...
            create_fragbond_graph=create_fragbond_graph,
        )
...
def mask_atom_features(batch):
    ...
    nmasks = round(batch["x_atoms"].shape[0] * 0.3)
