...
# env without matplotlib / PIL. Upstream hard-imported matplotlib at module top (line 2), which made
# `import fragnet.vizualize.model` fail with ModuleNotFoundError in the headless `fragnet` env.
...
from fragnet.dataset.fragments import FragmentedMol, get_3Dcoords
from fragnet.dataset.dataset import load_pickle_dataset
from fragnet.dataset.data import collate_fn
from fragnet.model.gat.gat2 import FragNetLayerA, FTHead1, FTHead2, FTHead3, FTHead4, FragNet
...
try:
    ...
    IPythonConsole = rdMolDraw2D = None
try:
...
class FragNetFineTuneBaseViz(nn.Module):
