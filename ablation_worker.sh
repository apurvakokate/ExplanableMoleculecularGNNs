...
# run_cell CELLID FAMILY OUTVAR DATASET FOLD GLOB -- <run.py argv...>
run_cell(){
  local cellid=$1 family=$2 outvar=$3 ds=$4 f=$5 glob=$6; shift 6; shift   # drop the '--'
...
# MoSE: 3 setups; MotifSAT: 2 setups. One knob each off the default (norm=none,unk=fixed,enc=onehot).
